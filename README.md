...
- Due to develop in a short time, i couldn't make most of spesific diagrams (ER, Activity, Sequence..), test cases, and i coded very bad on react include so much antipatterns etc. Sorry for that, you can pull request also!
